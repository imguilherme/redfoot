...
$license_ok_text = $license_ok ? "<mark class=\"yes\">".esc_html__("Verified", "uncode")."</mark>" : "<mark class=\"error\">".esc_html__("Not verified - Please register your copy of Uncode.", "uncode")."</mark>";

if (!$installationLegit) {
    $license_ok = false;
    $license_ok_text = "<mark class=\"error\">".esc_html__("Already used on other installation", "uncode")."</mark>";
}
?>
...
<table class="widefat" cellspacing="0" id="status">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="help"><?php echo '<a href="#" class="help_tip" data-tip="' . esc_attr__( 'Please validate your product license as outlined in Envato\'s license terms.', 'uncode' ) . '">[?]</a>'; ?></td>
                <td>
