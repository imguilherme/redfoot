...
function genesis_404() {
	...
	genesis_markup( array(
		...
		printf( '<h1 class="entry-title">%s</h1>', apply_filters( 'genesis_404_entry_title', __( 'Ixi, a página não foi encontrada.', 'genesis' ) ) );
		echo '<div class="entry-content">';

			if ( genesis_html5() ) :

				echo apply_filters( 'genesis_404_entry_content', '<p>' . sprintf( __( 'A página que você está procurando não existe mais - ou nunca existiu. Que tal voltar para a <a href="%s">página inicial</a>?', 'genesis' ), trailingslashit( home_url() ) ) . '</p>' );
	...
	?>
                        ...
                        <p><?php printf( __( 'A página que você está procurando não existe mais - ou nunca existiu. Que tal voltar para a <a href="%s">página inicial</a>?', 'genesis' ), trailingslashit( home_url() ) ); ?></p>
